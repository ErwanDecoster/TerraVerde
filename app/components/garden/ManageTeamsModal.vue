...
<template>
  ...
  >
    ...
    />
    <template #body>
      <div v-if="loading" class="py-4 text-center">Loading teams...</div>
      <div v-else>
        <div class="mb-6">
          <div v-if="canManageTeams">
            <UForm @submit.prevent="onAddTeam">
              <UFormField label="New Team Name" name="name">
                <UInput
                  v-model="newTeamName"
          ...
          <p v-else class="text-muted mb-4 text-xs">
        ...
        <div
          v-for="team in teams"
          :key="team.id"
          class="border-muted mb-8 rounded-lg border p-4"
        >
          ...
          <ul v-if="team.teams_members?.length" class="mb-2">
            <li
            ...
            >
              ...
              <span v-if="member.role" class="text-xs text-gray-500"
                >({{ member.role }})</span
              >
              <UButton
          ...
          <p v-else class="mb-2 text-xs text-gray-500">No members yet</p>
          <UForm
